...
//!
//! `request_id`: Request id selected by client
//! `num_fds`: Number of file descriptors
//!
//! ```txt
//! u64: (request_id << 8) | num_fds
//! ```
//!
//! **Response:**
//! ```txt
...
//! ```
//!
//! On error `num_fds` will be set to 255 and the rest of the message
//! is an error message string.
//! ```txt
//! u64: (request_id << 8) | 0xff
//! ...: error message
//! ```
//!
//! **Close file descriptors:**
//! Received file descriptors will be closed on dissconnect
//! or with an empty request (`request_id` = 0 and `num_fds` = 0).
//!
//! An empty request does **not** receive an response.
